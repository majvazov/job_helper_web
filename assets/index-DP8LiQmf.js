 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var U0;function q1(){if(U0)return De;U0=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),h=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),b=Symbol.iterator;function w(M){return M===null||typeof M!="object"?null:(M=b&&M[b]||M["@@iterator"],typeof M=="function"?M:null)}var I={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,z={};function U(M,ie,le){this.props=M,this.context=ie,this.refs=z,this.updater=le||I}U.prototype.isReactComponent={},U.prototype.setState=function(M,ie){if(typeof M!="object"&&typeof M!="function"&&M!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,M,ie,"setState")},U.prototype.forceUpdate=function(M){this.updater.enqueueForceUpdate(this,M,"forceUpdate")};function $(){}$.prototype=U.prototype;function Z(M,ie,le){this.props=M,this.context=ie,this.refs=z,this.updater=le||I}var Y=Z.prototype=new $;Y.constructor=Z,C(Y,U.prototype),Y.isPureReactComponent=!0;var H=Array.isArray,ee={H:null,A:null,T:null,S:null,V:null},ue=Object.prototype.hasOwnProperty;function N(M,ie,le,oe,ge,Re){return le=Re.ref,{$$typeof:r,type:M,key:ie,ref:le!==void 0?le:null,props:Re}}function x(M,ie){return N(M.type,ie,void 0,void 0,void 0,M.props)}function D(M){return typeof M=="object"&&M!==null&&M.$$typeof===r}function k(M){var ie={"=":"=0",":":"=2"};return"$"+M.replace(/[=:]/g,function(le){return ie[le]})}var P=/\/+/g;function V(M,ie){return typeof M=="object"&&M!==null&&M.key!=null?k(""+M.key):ie.toString(36)}function R(){}function Ce(M){switch(M.status){case"fulfilled":return M.value;case"rejected":throw M.reason;default:switch(typeof M.status=="string"?M.then(R,R):(M.status="pending",M.then(function(ie){M.status==="pending"&&(M.status="fulfilled",M.value=ie)},function(ie){M.status==="pending"&&(M.status="rejected",M.reason=ie)})),M.status){case"fulfilled":return M.value;case"rejected":throw M.reason}}throw M}function je(M,ie,le,oe,ge){var Re=typeof M;(Re==="undefined"||Re==="boolean")&&(M=null);var ye=!1;if(M===null)ye=!0;else switch(Re){case"bigint":case"string":case"number":ye=!0;break;case"object":switch(M.$$typeof){case r:case e:ye=!0;break;case v:return ye=M._init,je(ye(M._payload),ie,le,oe,ge)}}if(ye)return ge=ge(M),ye=oe===""?"."+V(M,0):oe,H(ge)?(le="",ye!=null&&(le=ye.replace(P,"$&/")+"/"),je(ge,ie,le,"",function(Vt){return Vt})):ge!=null&&(D(ge)&&(ge=x(ge,le+(ge.key==null||M&&M.key===ge.key?"":(""+ge.key).replace(P,"$&/")+"/")+ye)),ie.push(ge)),1;ye=0;var et=oe===""?".":oe+":";if(H(M))for(var Fe=0;Fe<M.length;Fe++)oe=M[Fe],Re=et+V(oe,Fe),ye+=je(oe,ie,le,Re,ge);else if(Fe=w(M),typeof Fe=="function")for(M=Fe.call(M),Fe=0;!(oe=M.next()).done;)oe=oe.value,Re=et+V(oe,Fe++),ye+=je(oe,ie,le,Re,ge);else if(Re==="object"){if(typeof M.then=="function")return je(Ce(M),ie,le,oe,ge);throw ie=String(M),Error("Objects are not valid as a React child (found: "+(ie==="[object Object]"?"object with keys {"+Object.keys(M).join(", ")+"}":ie)+"). If you meant to render a collection of children, use an array instead.")}return ye}function W(M,ie,le){if(M==null)return M;var oe=[],ge=0;return je(M,oe,"","",function(Re){return ie.call(le,Re,ge++)}),oe}function ce(M){if(M._status===-1){var ie=M._result;ie=ie(),ie.then(function(le){(M._status===0||M._status===-1)&&(M._status=1,M._result=le)},function(le){(M._status===0||M._status===-1)&&(M._status=2,M._result=le)}),M._status===-1&&(M._status=0,M._result=ie)}if(M._status===1)return M._result.default;throw M._result}var pe=typeof reportError=="function"?reportError:function(M){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var ie=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof M=="object"&&M!==null&&typeof M.message=="string"?String(M.message):String(M),error:M});if(!window.dispatchEvent(ie))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",M);return}console.error(M)};function Ae(){}return De.Children={map:W,forEach:function(M,ie,le){W(M,function(){ie.apply(this,arguments)},le)},count:function(M){var ie=0;return W(M,function(){ie++}),ie},toArray:function(M){return W(M,function(ie){return ie})||[]},only:function(M){if(!D(M))throw Error("React.Children.only expected to receive a single React element child.");return M}},De.Component=U,De.Fragment=t,De.Profiler=o,De.PureComponent=Z,De.StrictMode=s,De.Suspense=m,De.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=ee,De.__COMPILER_RUNTIME={__proto__:null,c:function(M){return ee.H.useMemoCache(M)}},De.cache=function(M){return function(){return M.apply(null,arguments)}},De.cloneElement=function(M,ie,le){if(M==null)throw Error("The argument must be a React element, but you passed "+M+".");var oe=C({},M.props),ge=M.key,Re=void 0;if(ie!=null)for(ye in ie.ref!==void 0&&(Re=void 0),ie.key!==void 0&&(ge=""+ie.key),ie)!ue.call(ie,ye)||ye==="key"||ye==="__self"||ye==="__source"||ye==="ref"&&ie.ref===void 0||(oe[ye]=ie[ye]);var ye=arguments.length-2;if(ye===1)oe.children=le;else if(1<ye){for(var et=Array(ye),Fe=0;Fe<ye;Fe++)et[Fe]=arguments[Fe+2];oe.children=et}return N(M.type,ge,void 0,void 0,Re,oe)},De.createContext=function(M){return M={$$typeof:h,_currentValue:M,_currentValue2:M,_threadCount:0,Provider:null,Consumer:null},M.Provider=M,M.Consumer={$$typeof:u,_context:M},M},De.createElement=function(M,ie,le){var oe,ge={},Re=null;if(ie!=null)for(oe in ie.key!==void 0&&(Re=""+ie.key),ie)ue.call(ie,oe)&&oe!=="key"&&oe!=="__self"&&oe!=="__source"&&(ge[oe]=ie[oe]);var ye=arguments.length-2;if(ye===1)ge.children=le;else if(1<ye){for(var et=Array(ye),Fe=0;Fe<ye;Fe++)et[Fe]=arguments[Fe+2];ge.children=et}if(M&&M.defaultProps)for(oe in ye=M.defaultProps,ye)ge[oe]===void 0&&(ge[oe]=ye[oe]);return N(M,Re,void 0,void 0,null,ge)},De.createRef=function(){return{current:null}},De.forwardRef=function(M){return{$$typeof:p,render:M}},De.isValidElement=D,De.lazy=function(M){return{$$typeof:v,_payload:{_status:-1,_result:M},_init:ce}},De.memo=function(M,ie){return{$$typeof:g,type:M,compare:ie===void 0?null:ie}},De.startTransition=function(M){var ie=ee.T,le={};ee.T=le;try{var oe=M(),ge=ee.S;ge!==null&&ge(le,oe),typeof oe=="object"&&oe!==null&&typeof oe.then=="function"&&oe.then(Ae,pe)}catch(Re){pe(Re)}finally{ee.T=ie}},De.unstable_useCacheRefresh=function(){return ee.H.useCacheRefresh()},De.use=function(M){return ee.H.use(M)},De.useActionState=function(M,ie,le){return ee.H.useActionState(M,ie,le)},De.useCallback=function(M,ie){return ee.H.useCallback(M,ie)},De.useContext=function(M){return ee.H.useContext(M)},De.useDebugValue=function(){},De.useDeferredValue=function(M,ie){return ee.H.useDeferredValue(M,ie)},De.useEffect=function(M,ie,le){var oe=ee.H;if(typeof le=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return oe.useEffect(M,ie)},De.useId=function(){return ee.H.useId()},De.useImperativeHandle=function(M,ie,le){return ee.H.useImperativeHandle(M,ie,le)},De.useInsertionEffect=function(M,ie){return ee.H.useInsertionEffect(M,ie)},De.useLayoutEffect=function(M,ie){return ee.H.useLayoutEffect(M,ie)},De.useMemo=function(M,ie){return ee.H.useMemo(M,ie)},De.useOptimistic=function(M,ie){return ee.H.useOptimistic(M,ie)},De.useReducer=function(M,ie,le){return ee.H.useReducer(M,ie,le)},De.useRef=function(M){return ee.H.useRef(M)},De.useState=function(M){return ee.H.useState(M)},De.useSyncExternalStore=function(M,ie,le){return ee.H.useSyncExternalStore(M,ie,le)},De.useTransition=function(){return ee.H.useTransition()},De.version="19.1.0",De}var j0;function yg(){return j0||(j0=1,sm.exports=q1()),sm.exports}var j=yg();const Ro=Wb(j);var am={exports:{}},uu={},om={exports:{}},lm={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var z0;function B1(){return z0||(z0=1,function(r){function e(W,ce){var pe=W.length;W.push(ce);e:for(;0<pe;){var Ae=pe-1>>>1,M=W[Ae];if(0<o(M,ce))W[Ae]=ce,W[pe]=M,pe=Ae;else break e}}function t(W){return W.length===0?null:W[0]}function s(W){if(W.length===0)return null;var ce=W[0],pe=W.pop();if(pe!==ce){W[0]=pe;e:for(var Ae=0,M=W.length,ie=M>>>1;Ae<ie;){var le=2*(Ae+1)-1,oe=W[le],ge=le+1,Re=W[ge];if(0>o(oe,pe))ge<M&&0>o(Re,oe)?(W[Ae]=Re,W[ge]=pe,Ae=ge):(W[Ae]=oe,W[le]=pe,Ae=le);else if(ge<M&&0>o(Re,pe))W[Ae]=Re,W[ge]=pe,Ae=ge;else break e}}return ce}function o(W,ce){var pe=W.sortIndex-ce.sortIndex;return pe!==0?pe:W.id-ce.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var h=Date,p=h.now();r.unstable_now=function(){return h.now()-p}}var m=[],g=[],v=1,b=null,w=3,I=!1,C=!1,z=!1,U=!1,$=typeof setTimeout=="function"?setTimeout:null,Z=typeof clearTimeout=="function"?clearTimeout:null,Y=typeof setImmediate<"u"?setImmediate:null;function H(W){for(var ce=t(g);ce!==null;){if(ce.callback===null)s(g);else if(ce.startTime<=W)s(g),ce.sortIndex=ce.expirationTime,e(m,ce);else break;ce=t(g)}}function ee(W){if(z=!1,H(W),!C)if(t(m)!==null)C=!0,ue||(ue=!0,V());else{var ce=t(g);ce!==null&&je(ee,ce.startTime-W)}}var ue=!1,N=-1,x=5,D=-1;function k(){return U?!0:!(r.unstable_now()-D<x)}function P(){if(U=!1,ue){var W=r.unstable_now();D=W;var ce=!0;try{e:{C=!1,z&&(z=!1,Z(N),N=-1),I=!0;var pe=w;try{t:{for(H(W),b=t(m);b!==null&&!(b.expirationTime>W&&k());){var Ae=b.callback;if(typeof Ae=="function"){b.callback=null,w=b.priorityLevel;var M=Ae(b.expirationTime<=W);if(W=r.unstable_now(),typeof M=="function"){b.callback=M,H(W),ce=!0;break t}b===t(m)&&s(m),H(W)}else s(m);b=t(m)}if(b!==null)ce=!0;else{var ie=t(g);ie!==null&&je(ee,ie.startTime-W),ce=!1}}break e}finally{b=null,w=pe,I=!1}ce=void 0}}finally{ce?V():ue=!1}}}var V;if(typeof Y=="function")V=function(){Y(P)};else if(typeof MessageChannel<"u"){var R=new MessageChannel,Ce=R.port2;R.port1.onmessage=P,V=function(){Ce.postMessage(null)}}else V=function(){$(P,0)};function je(W,ce){N=$(function(){W(r.unstable_now())},ce)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(W){W.callback=null},r.unstable_forceFrameRate=function(W){0>W||125<W?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):x=0<W?Math.floor(1e3/W):5},r.unstable_getCurrentPriorityLevel=function(){return w},r.unstable_next=function(W){switch(w){case 1:case 2:case 3:var ce=3;break;default:ce=w}var pe=w;w=ce;try{return W()}finally{w=pe}},r.unstable_requestPaint=function(){U=!0},r.unstable_runWithPriority=function(W,ce){switch(W){case 1:case 2:case 3:case 4:case 5:break;default:W=3}var pe=w;w=W;try{return ce()}finally{w=pe}},r.unstable_scheduleCallback=function(W,ce,pe){var Ae=r.unstable_now();switch(typeof pe=="object"&&pe!==null?(pe=pe.delay,pe=typeof pe=="number"&&0<pe?Ae+pe:Ae):pe=Ae,W){case 1:var M=-1;break;case 2:M=250;break;case 5:M=1073741823;break;case 4:M=1e4;break;default:M=5e3}return M=pe+M,W={id:v++,callback:ce,priorityLevel:W,startTime:pe,expirationTime:M,sortIndex:-1},pe>Ae?(W.sortIndex=pe,e(g,W),t(m)===null&&W===t(g)&&(z?(Z(N),N=-1):z=!0,je(ee,pe-Ae))):(W.sortIndex=M,e(m,W),C||I||(C=!0,ue||(ue=!0,V()))),W},r.unstable_shouldYield=k,r.unstable_wrapCallback=function(W){var ce=w;return function(){var pe=w;w=ce;try{return W.apply(this,arguments)}finally{w=pe}}}}(lm)),lm}var q0;function H1(){return q0||(q0=1,om.exports=B1()),om.exports}var um={exports:{}},nn={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class To{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Te(e.idToken,"internal-error"),Te(typeof e.idToken<"u","internal-error"),Te(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):cE(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){Te(e.length!==0,"internal-error");const t=cE(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(Te(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:o,expiresIn:u}=await _C(e,t);this.updateTokensAndExpiration(s,o,Number(u))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:o,expirationTime:u}=t,h=new To;return s&&(Te(typeof s=="string","internal-error",{appName:e}),h.refreshToken=s),o&&(Te(typeof o=="string","internal-error",{appName:e}),h.accessToken=o),u&&(Te(typeof u=="number","internal-error",{appName:e}),h.expirationTime=u),h}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new To,this.toJSON())}_performRefresh(){return ui("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VC(r,e){const t=Ig(r,"auth");if(t.isInitialized()){const o=t.getImmediate(),u=t.getOptions();if(mi(u,e??{}))return o;or(o,"already-initialized")}return t.initialize({options:e})}function LC(r,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(ci);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function UC(r,e,t){const s=va(r);Te(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const o=!1,u=HT(e),{host:h,port:p}=jC(e),m=p===null?"":`:${p}`,g={url:`${u}//${h}${m}/`},v=Object.freeze({host:h,port:p,protocol:u.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!s._canInitEmulator){Te(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),Te(mi(g,s.config.emulator)&&mi(v,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=g,s.emulatorConfig=v,s.settings.appVerificationDisabledForTesting=!0,zC()}function HT(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function jC(r){const e=HT(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(s);if(o){const u=o[1];return{host:u,port:gE(s.substr(u.length+1))}}else{const[u,h]=s.split(":");return{host:u,port:gE(h)}}}function gE(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function zC(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function XC(r,e,t=!1){const{auth:s}=r;if(Qn(s.app))return Promise.reject(fi(s));const o="reauthenticate";try{const u=await xo(r,$T(s,o,e,r),t);Te(u.idToken,s,"internal-error");const h=Ng(u.idToken);Te(h,s,"internal-error");const{sub:p}=h;return Te(r.uid===p,s,"user-mismatch"),pa._forOperation(r,o,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&or(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bD(r,e){return e?ci(e):(Te(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const FD=new Uu(5e3,15e3),$D="__/auth/iframe",GD="emulator/auth/iframe",KD={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},QD=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function YD(r){const e=r.config;Te(e.authDomain,r,"auth-domain-config-required");const t=e.emulator?Dg(e,GD):`https://${r.config.authDomain}/${$D}`,s={apiKey:e.apiKey,appName:r.name,v:Go},o=QD.get(r.config.apiHost);o&&(s.eid=o);const u=r._getFrameworks();return u.length&&(s.fw=u.join(",")),`${t}?${Lu(s).slice(1)}`}async function XD(r){const e=await HD(r),t=Nr().gapi;return Te(t,r,"internal-error"),e.open({where:document.body,url:YD(r),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:KD,dontclear:!0},s=>new Promise(async(o,u)=>{await s.restyle({setHideOnLeave:!1});const h=Dr(r,"network-request-failed"),p=Nr().setTimeout(()=>{u(h)},FD.get());function m(){Nr().clearTimeout(p),o(s)}s.ping(m).then(m,()=>{u(h)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iN="__/auth/handler",sN="emulator/auth/handler",aN=encodeURIComponent("fac");async function wE(r,e,t,s,o,u){Te(r.config.authDomain,r,"auth-domain-config-required"),Te(r.config.apiKey,r,"invalid-api-key");const h={apiKey:r.config.apiKey,appName:r.name,authType:t,redirectUrl:s,v:Go,eventId:o};if(e instanceof FT){e.setDefaultLanguage(r.languageCode),h.providerId=e.providerId||"",HI(e.getCustomParameters())||(h.customParameters=JSON.stringify(e.getCustomParameters()));for(const[v,b]of Object.entries({}))h[v]=b}if(e instanceof zu){const v=e.getScopes().filter(b=>b!=="");v.length>0&&(h.scopes=v.join(","))}r.tenantId&&(h.tid=r.tenantId);const p=h;for(const v of Object.keys(p))p[v]===void 0&&delete p[v];const m=await r._getAppCheckToken(),g=m?`#${aN}=${encodeURIComponent(m)}`:"";return`${oN(r)}?${Lu(p).slice(1)}${g}`}function oN({config:r}){return r.emulator?Dg(r,sN):`https://${r.authDomain}/${iN}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vm="webStorageSupport";class lN{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=WT,this._completeRedirectFn=kD,this._overrideRedirectResult=CD}async _openPopup(e,t,s,o){var u;yi((u=this.eventManagers[e._key()])===null||u===void 0?void 0:u.manager,"_initialize() not called before _openPopup()");const h=await wE(e,t,s,qm(),o);return nN(e,h,Pg())}async _openRedirect(e,t,s,o){await this._originValidation(e);const u=await wE(e,t,s,qm(),o);return hD(u),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:u}=this.eventManagers[t];return o?Promise.resolve(o):(yi(u,"If manager is not set, promise should be"),u)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await XD(e),s=new MD(e);return t.register("authEvent",o=>(Te(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:s.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(vm,{type:vm},o=>{var u;const h=(u=o==null?void 0:o[0])===null||u===void 0?void 0:u[vm];h!==void 0&&t(!!h),or(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=jD(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return jT()||OT()||kg()}}const uN=lN;var SE="@firebase/auth",AE="1.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hN(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function fN(r){Io(new fa("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:h,authDomain:p}=s.options;Te(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const m={apiKey:h,authDomain:p,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:zT(r)},g=new IC(s,o,u,m);return LC(g,t),g},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),Io(new fa("auth-internal",e=>{const t=va(e.getProvider("auth").getImmediate());return(s=>new cN(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),us(SE,AE,hN(r)),us(SE,AE,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(r="Unexpected state"){const e=`FIRESTORE (${Qo}) INTERNAL ASSERTION FAILED: `+r;throw vi(e),new Error(e)}function Xe(r,e){r||Se()}function xe(r,e){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,FV=X.div`
  ...
  display: flex;
  flex-direction: column;
`,$V=()=>{const{currentUser:r,logout:e}=Pr(),[t,s]=j.useState([]),[o,u]=j.useState(!0),[h,p]=j.useState(!1),[m,g]=j.useState(null),[v,b]=j.useState({title:"",description:"",location:"",type:"Full-time",salary:"",requirements:"",benefits:"",category:"customer-service"}),[w,I]=j.useState({}),[C,z]=j.useState([]),[U,$]=j.useState(null),[Z,Y]=j.useState(!1);j.useEffect(()=>{H()},[r]);const H=async()=>{if(r){const[k,P]=await Promise.all([iP(r.uid),kO(r.uid)]);if(P)g(P);else{const R=await zS(r.uid,{companyName:r.displayName||"Default Company Name",email:r.email,phone:"",address:"",website:"",description:""});g(R)}s(k);const V={};await Promise.all(k.map(async R=>{const Ce=await hP(R.id),je=await Promise.all(Ce.map(async W=>{const ce=W.applicantId||W.userId;if(!ce)return console.error("No applicant ID found in application:",W),{...W,applicantName:"Anonymous User",applicantEmail:"No email provided"};const pe=pn(Ye,"users",ce),M=(await vs(pe)).data()||{};return{...W,applicantName:M.name||"Anonymous User",applicantEmail:M.email||"No email provided"}}));V[R.id]=je})),I(V),u(!1)}},ee=k=>{const{name:P,value:V}=k.target;b(R=>({...R,[P]:V}))},ue=async k=>{k.preventDefault();try{if(!m){console.error("Employer profile not found");return}const P={...v,employerId:r.uid,company:m.companyName,requirements:v.requirements?v.requirements.split(",").map(V=>V.trim()):[],benefits:v.benefits?v.benefits.split(",").map(V=>V.trim()):[]};await sP(P),await H(),p(!1),b({title:"",description:"",location:"",type:"Full-time",salary:"",requirements:"",benefits:"",category:"customer-service"})}catch(P){console.error("Error posting job:",P)}},N=async k=>{if(window.confirm("Are you sure you want to delete this job posting?"))try{await aP(k),await H()}catch(P){console.error("Error deleting job:",P)}},x=async()=>{try{await e()}catch(k){console.error("Error logging out:",k)}};j.useEffect(()=>{(async()=>{if(!(r!=null&&r.uid))return;const P=dn(Ye,"applications"),V=sr(P,Ft("employerId","==",r.uid));try{const R=await ur(V),Ce=await Promise.all(R.docs.map(async je=>{const W=je.data(),ce=W.applicantId||W.userId;if(!ce)return console.error("No applicant ID found in application:",W),{id:je.id,...W,applicantName:"Anonymous User",applicantEmail:"No email provided"};const pe=je(Ye,"users",ce),M=(await vs(pe)).data()||{};return{id:je.id,...W,applicantId:ce,applicantName:M.name||"Anonymous User",applicantEmail:M.email||"No email provided"}}));z(Ce),u(!1)}catch(R){console.error("Error fetching applications:",R),u(!1)}})()},[r]);const D=k=>{console.log("Opening message modal for application:",k),$(k),Y(!0)};return o?S.jsx("div",{children:"Loading..."}):S.jsxs(AV,{children:[S.jsx("h2",{children:"Employer Dashboard"}),S.jsx(Yh,{onClick:()=>p(!h),style:{marginBottom:"2rem"},children:h?"Cancel":"Post New Job"}),h&&S.jsxs(RV,{onSubmit:ue,children:[S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Job Title"}),S.jsx(Nm,{type:"text",name:"title",value:v.title,onChange:ee,required:!0})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Job Description"}),S.jsx(km,{name:"description",value:v.description,onChange:ee,required:!0})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Location"}),S.jsx(Nm,{type:"text",name:"location",value:v.location,onChange:ee,required:!0})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Job Type"}),S.jsxs(Yb,{name:"type",value:v.type,onChange:ee,required:!0,children:[S.jsx("option",{value:"Full-time",children:"Full-time"}),S.jsx("option",{value:"Part-time",children:"Part-time"}),S.jsx("option",{value:"Contract",children:"Contract"}),S.jsx("option",{value:"Internship",children:"Internship"})]})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Category"}),S.jsxs(Yb,{name:"category",value:v.category,onChange:ee,required:!0,children:[S.jsx("option",{value:"customer-service",children:"Customer Service"}),S.jsx("option",{value:"web-developer",children:"Web Developer"}),S.jsx("option",{value:"sales",children:"Sales"}),S.jsx("option",{value:"admin",children:"Administrative"}),S.jsx("option",{value:"data-entry",children:"Data Entry"}),S.jsx("option",{value:"social-media",children:"Social Media"})]})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Salary Range"}),S.jsx(Nm,{type:"text",name:"salary",value:v.salary,onChange:ee,placeholder:"e.g. $30,000 - $40,000",required:!0})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Requirements (comma-separated)"}),S.jsx(km,{name:"requirements",value:v.requirements,onChange:ee,placeholder:"e.g. High school diploma, Good communication skills, Basic computer knowledge",required:!0})]}),S.jsxs(Ji,{children:[S.jsx(Zi,{children:"Benefits (comma-separated)"}),S.jsx(km,{name:"benefits",value:v.benefits,onChange:ee,placeholder:"e.g. Health insurance, 401k, Paid time off",required:!0})]}),S.jsx(Yh,{type:"submit",children:"Post Job"})]}),S.jsx(PV,{children:"Your Job Postings"}),S.jsx(IV,{children:t.map(k=>{var P,V;return S.jsxs(xV,{children:[S.jsx("h4",{children:k.title}),S.jsxs(CV,{children:[S.jsxs("p",{children:[S.jsx("strong",{children:"Location:"})," ",k.location]}),S.jsxs("p",{children:[S.jsx("strong",{children:"Type:"})," ",k.type]}),S.jsxs("p",{children:[S.jsx("strong",{children:"Salary:"})," ",k.salary]}),S.jsxs("p",{children:[S.jsx("strong",{children:"Applications:"})," ",((P=w[k.id])==null?void 0:P.length)||0]})]}),S.jsx(kV,{children:(V=w[k.id])==null?void 0:V.map(R=>S.jsxs(OV,{children:[S.jsxs(MV,{children:[S.jsxs("h5",{children:["Application from ",R.applicantName]}),S.jsxs("p",{children:[S.jsx("strong",{children:"Email:"})," ",R.applicantEmail]}),S.jsxs("p",{children:[S.jsx("strong",{children:"Submitted:"})," ",new Date(R.submittedAt).toLocaleDateString()]}),S.jsx("p",{children:S.jsx("strong",{children:"Motivation Letter:"})}),S.jsx("p",{children:R.motivationLetter})]}),S.jsx(Xb,{onClick:()=>D(R),children:"Message Applicant"})]},R.id))}),S.jsx(DV,{children:S.jsx(Yh,{onClick:()=>N(k.id),className:"delete",children:"Delete"})})]},k.id)})}),S.jsx(NV,{onClick:x,children:"Logout"}),S.jsxs(VV,{children:[S.jsx(LV,{children:"Applications Received"}),S.jsx(UV,{children:C.map(k=>{var P;return S.jsxs(FV,{children:[S.jsx(jV,{children:k.applicantName}),S.jsxs(zV,{children:[S.jsxs("p",{children:["Position: ",k.jobTitle]}),S.jsxs("p",{children:["Applied: ",new Date((P=k.timestamp)==null?void 0:P.toDate()).toLocaleDateString()]})]}),S.jsx(Xb,{onClick:()=>D(k),children:"Message Applicant"})]},k.id)})})]}),Z&&U&&S.jsx(qV,{children:S.jsxs(BV,{children:[S.jsx(HV,{onClick:()=>Y(!1),children:"×"}),S.jsxs("h3",{children:["Messaging ",U.applicantName]}),S.jsx(rd,{senderId:r.uid,receiverId:U.userId||U.applicantId,applicationId:U.id})]})})]})},Om=({children:r})=>{const{currentUser:e}=Pr();return e?r:S.jsx(jR,{to:"/login"})},GV=X.div`
  background: white;
  border-radius: 12px;
...
`,u4=()=>{const{currentUser:r}=Pr(),{refreshUnreadCount:e}=Ey(),[t,s]=j.useState([]),[o,u]=j.useState({}),[h,p]=j.useState({}),[m,g]=j.useState(!0),[v,b]=j.useState(null),[w,I]=j.useState(!0),C=async()=>{if(r!=null&&r.uid)try{g(!0),console.log("Fetching conversations for user:",r.uid);const H=await BS(r.uid);s(H);const ue=[...new Set(H.map(R=>R.otherUserId))].map(async R=>{const Ce=await lP(R);return{[R]:Ce}}),x=[...new Set(H.map(R=>R.applicationId).filter(R=>R&&R!=="default"))].map(async R=>{try{const Ce=await fP(R);return{[R]:Ce}}catch(Ce){return console.error(`Error fetching application ${R}:`,Ce),{[R]:null}}}),[D,k]=await Promise.all([Promise.all(ue),Promise.all(x)]),P=D.reduce((R,Ce)=>({...R,...Ce}),{}),V=k.reduce((R,Ce)=>({...R,...Ce}),{});u(P),p(V),r!=null&&r.uid&&e(r.uid)}catch(H){console.error("Error fetching conversations:",H)}finally{g(!1)}};j.useEffect(()=>{C();const H=setInterval(()=>{C()},3e4);return()=>clearInterval(H)},[r]);const z=async H=>{b(H),window.innerWidth<=768&&I(!1),H.unread>0&&(await MO(r.uid,H.otherUserId,H.applicationId),s(t.map(ee=>ee.id===H.id?{...ee,unread:0}:ee)),e(r.uid))},U=H=>{if(!H)return"";let ee;H instanceof dt?ee=H.toDate():H.seconds?ee=new Date(H.seconds*1e3):H instanceof Date?ee=H:ee=new Date(H);const ue=new Date;return ee.toDateString()===ue.toDateString()?ee.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):ee.getFullYear()===ue.getFullYear()?ee.toLocaleDateString([],{month:"short",day:"numeric"}):ee.toLocaleDateString([],{year:"numeric",month:"short",day:"numeric"})},$=H=>H.split(" ").map(ee=>ee[0]).join("").toUpperCase().slice(0,2),Z=()=>{I(!0)},Y=()=>{if(!v)return"";const H=o[v.otherUserId]||{};return H.displayName||H.companyName||"Unknown User"};return S.jsxs(GV,{children:[S.jsxs(KV,{children:["Messages",S.jsx(o4,{onClick:Z,$show:!w&&v,children:"← Back to Messages"}),S.jsx(QV,{to:"/profile",children:S.jsx("svg",{viewBox:"0 0 24 24",children:S.jsx("path",{d:"M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"})})})]}),S.jsxs(n4,{children:[S.jsx(YV,{$hideOnMobile:!w,children:m?S.jsx("div",{style:{padding:"1rem"},children:"Loading conversations..."}):t.length===0?S.jsxs("div",{style:{padding:"1rem"},children:["No conversations yet.",S.jsx("div",{style:{marginTop:"0.5rem",fontSize:"0.9rem",color:"#666"},children:"If you've sent messages before, they might be stored with different user IDs."})]}):t.map(H=>{const ee=o[H.otherUserId]||{},ue=ee.displayName||ee.companyName||"Unknown User",N=h[H.applicationId];return S.jsxs(XV,{onClick:()=>z(H),$active:(v==null?void 0:v.id)===H.id,$unread:H.unread>0,children:[S.jsx(WV,{children:$(ue)}),S.jsxs(JV,{children:[S.jsx(ZV,{$unread:H.unread>0,children:ue}),N&&S.jsxs(a4,{children:["Re: ",N.jobTitle||"Job Application"]}),S.jsx(e4,{children:H.content}),S.jsx(i4,{children:U(H.timestamp)})]}),H.unread>0&&S.jsx(t4,{children:H.unread})]},`${H.applicationId}-${H.otherUserId}`)})}),S.jsx(s4,{children:v?S.jsxs(S.Fragment,{children:[!w&&S.jsx(l4,{children:S.jsx("h3",{children:Y()})}),S.jsx(rd,{applicationId:v.applicationId,senderId:r.uid,receiverId:v.otherUserId})]}):S.jsx(r4,{children:"Select a conversation to start messaging"})})]})]})};function c4(){return S.jsx(cI,{children:S.jsx(OO,{children:S.jsx(PO,{children:S.jsxs("div",{className:"app",children:[S.jsx(YM,{}),S.jsx("main",{className:"main-content",children:S.jsxs(qR,{children:[S.jsx(es,{path:"/",element:S.jsx(LP,{})}),S.jsx(es,{path:"/login",element:S.jsx(BP,{})}),S.jsx(es,{path:"/register",element:S.jsx(QP,{})}),S.jsx(es,{path:"/profile",element:S.jsx(Om,{children:S.jsx(SV,{})})}),S.jsx(es,{path:"/employer/dashboard",element:S.jsx(Om,{children:S.jsx($V,{})})}),S.jsx(es,{path:"/messages",element:S.jsx(Om,{children:S.jsx(u4,{})})}),S.jsx(es,{path:"/interview/:jobType",element:S.jsx(pA,{})})]})}),S.jsx(nP,{})]})})})})}Y1.createRoot(document.getElementById("root")).render(S.jsx(Ro.StrictMode,{children:S.jsx(c4,{})}));
